 ...
 */
public class SuoFang_pingyi_View extends View {

    private Paint mPaint = new Paint();
    private int mWidth, mHeight;

    public SuoFang_pingyi_View(Context context) {
        super(context, null);
    }

    public SuoFang_pingyi_View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
