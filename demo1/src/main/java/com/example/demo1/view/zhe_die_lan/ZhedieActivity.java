package com.example.demo1.view.zhe_die_lan;
...
import com.example.demo1.view.huaweishichang_search.MarketActivity;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by yida on 2018/12/11.
 */
public class ZhedieActivity extends AppCompatActivity {
...
//        mBanner = findViewById(R.id.convenientBanner);
        ...
        mRecyclerView = findViewById(R.id.rv_aaa);
...
//                return new MarketActivity.NetWorkImageHoler(itemView);
//            }
//
//            @Override
...
//        mSearchBar.setSearchIcon(R.mipmap.ic_search) // 设置搜索的icon
