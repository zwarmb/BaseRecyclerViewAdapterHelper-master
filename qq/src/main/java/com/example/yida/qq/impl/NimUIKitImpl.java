package com.example.yida.qq.impl;
...
import com.example.yida.qq.api.UIKitInitStateListener;
import com.example.yida.qq.api.UIKitOptions;
import com.example.yida.qq.api.model.chatroom.ChatRoomMemberChangedObservable;
import com.example.yida.qq.api.model.chatroom.ChatRoomProvider;
import com.example.yida.qq.api.model.chatroom.ChatRoomSessionCustomization;
import com.example.yida.qq.api.model.contact.ContactChangedObservable;
import com.example.yida.qq.api.model.contact.ContactEventListener;
import com.example.yida.qq.api.model.contact.ContactProvider;
import com.example.yida.qq.api.model.main.CustormPushContentProvider;
import com.example.yida.qq.api.model.main.LoginSyncDataStatusObserver;
import com.example.yida.qq.api.model.main.OnlineStateChangeObservable;
import com.example.yida.qq.api.model.main.OnlineStateContentProvider;
import com.example.yida.qq.api.model.recent.RecentCustomization;
import com.example.yida.qq.api.model.robot.RobotInfoProvider;
import com.example.yida.qq.api.model.session.SessionCustomization;
import com.example.yida.qq.api.model.session.SessionEventListener;
import com.example.yida.qq.api.model.team.TeamChangedObservable;
import com.example.yida.qq.api.model.team.TeamProvider;
import com.example.yida.qq.api.model.user.IUserInfoProvider;
import com.example.yida.qq.api.model.user.UserInfoObservable;
import com.example.yida.qq.business.chatroom.fragment.ChatRoomMessageFragment;
import com.example.yida.qq.business.chatroom.viewholder.ChatRoomMsgViewHolderBase;
import com.example.yida.qq.business.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
import com.example.yida.qq.business.contact.selector.activity.ContactSelectActivity;
import com.example.yida.qq.business.session.activity.P2PMessageActivity;
import com.example.yida.qq.business.session.activity.TeamMessageActivity;
import com.example.yida.qq.business.session.audio.MessageAudioControl;
import com.example.yida.qq.business.session.emoji.StickerManager;
import com.example.yida.qq.business.session.module.MsgForwardFilter;
import com.example.yida.qq.business.session.module.MsgRevokeFilter;
import com.example.yida.qq.business.session.viewholder.MsgViewHolderBase;
import com.example.yida.qq.business.session.viewholder.MsgViewHolderFactory;
import com.example.yida.qq.business.team.activity.AdvancedTeamInfoActivity;
import com.example.yida.qq.business.team.activity.NormalTeamInfoActivity;
import com.example.yida.qq.common.util.log.LogUtil;
import com.example.yida.qq.common.util.storage.StorageType;
import com.example.yida.qq.common.util.storage.StorageUtil;
import com.example.yida.qq.common.util.sys.ScreenUtil;
import com.example.yida.qq.impl.cache.ChatRoomCacheManager;
import com.example.yida.qq.impl.cache.DataCacheManager;
import com.example.yida.qq.impl.customization.DefaultContactEventListener;
import com.example.yida.qq.impl.customization.DefaultP2PSessionCustomization;
import com.example.yida.qq.impl.customization.DefaultRecentCustomization;
import com.example.yida.qq.impl.customization.DefaultTeamSessionCustomization;
import com.example.yida.qq.impl.preference.UserPreferences;
import com.example.yida.qq.impl.provider.DefaultChatRoomProvider;
import com.example.yida.qq.impl.provider.DefaultContactProvider;
import com.example.yida.qq.impl.provider.DefaultRobotProvider;
import com.example.yida.qq.impl.provider.DefaultTeamProvider;
import com.example.yida.qq.impl.provider.DefaultUserInfoProvider;
import com.example.yida.qq.support.glide.ImageLoaderKit;
...
public final class NimUIKitImpl {
    ...
    // 自定义推送配置
    private static CustormPushContentProvider customPushContentProvider;
    ...
    */
    ...
    public static CustormPushContentProvider getCustomPushContentProvider() {
        return customPushContentProvider;
    }

    public static void setCustomPushContentProvider(CustormPushContentProvider mixPushCustomConfig) {
