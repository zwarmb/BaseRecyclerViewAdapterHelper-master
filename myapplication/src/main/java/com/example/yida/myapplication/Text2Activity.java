...
import com.example.yida.myapplication.adapter.ExpandFoldtextAdapter;
...
class Text2Activity extends AppCompatActivity {
    ...
    private void initRecycleView() {
        ExpandFoldtextAdapter adapter = new ExpandFoldtextAdapter(this, mList);
