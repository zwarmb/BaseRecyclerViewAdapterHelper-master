package com.example.yida.qq.api;
...
public class NimUIKit {
     ...
     * 则定制化信息 SessionCustomization 为{@link com.example.yida.qq.impl.customization.DefaultP2PSessionCustomization}
     * <p>
     ...
     * 则定制化信息 SessionCustomization 为{@link com.example.yida.qq.impl.customization.DefaultTeamSessionCustomization}
     * <p>
     * 若需要为目标会话提供单独定义的SessionCustomization，请使用{@link NimUIKitImpl#startChatting(Context, String, SessionTypeEnum, SessionCustomization, IMMessage)}
     *
     * @param context 上下文
